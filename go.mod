...
require (
	...
	github.com/checkpoint-restore/go-criu/v8 v8.2.0 // indirect
...
replace go.podman.io/podman/v6 => github.com/cfergeau/podman-macadam/v6 v6.0.0-20260619141534-8975b8e9e7e4
